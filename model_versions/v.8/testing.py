...
with h5py.File('../../splitData/newData/split_aug_v6.h5', 'r') as gData:
...
#train(model, train_data, batch_size= 1, num_epochs=30, val_True = True, val_data = val_data, lr = 0.01)

state = torch.load('./checkpoints/2/model_galaxyNet_bs20_lr0.01_epoch48_acc81')
model.load_state_dict(state)

test_loader = torch.utils.data.DataLoader(test_data, batch_size= 10, shuffle=True)
#get_accuracy(model,test_loader)*100
