...
def get_model_name(name, batch_size, learning_rate, epoch,valAcc):
    ...
    """
    valAcc = str(int(round(valAcc, 2)*100))
...
class galaxy_model(nn.Module):
  def __init__(self, img_size=70, out1_channels=32, out2_channels=60, out3_channels=100,kernal_size=3, lastOutput = 10):
    ...
    self.bn1 = nn.BatchNorm2d(out1_channels)
    ...
    self.bn2 = nn.BatchNorm2d(out2_channels)
    ...
    self.bn3 = nn.BatchNorm2d(out3_channels)
    ...
    self.bn_fc = nn.BatchNorm1d(lastOutput)
