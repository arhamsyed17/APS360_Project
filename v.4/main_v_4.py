...
from model_architecture_v_4 import *
...
with h5py.File('../split_aug_v3.h5', 'r') as gData:
...
train(model, train_data, batch_size=10, num_epochs=100, val_True = True, val_data = val_data, lr = 0.001)
